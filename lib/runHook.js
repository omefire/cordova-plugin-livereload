...
module.exports = function(context) {
	...
	ios: 'platforms/ios/HelloCordova' // ToDO: make sure this is the correct location
    };
    ...
    return Q()
        ...
        .then(function() {
	        ...
	        var msg = 'Livereload failed on all platforms, thus the "run" process is being aborted ... ';
	        console.log('cordova-plugin-livereload: Livereload failed on all platforms, thus the "run" process is being aborted ... ');
                return Q.reject(msg);
            }
            return Q();
        });
