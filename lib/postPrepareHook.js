...
module.exports = function(context) {
    ...
    var startPage = helpers.GetStartPage(projectRoot),
        ...
        lr = new LiveReload(projectRoot, platform_wwws, {
            files: [{
                ...
                fn: function(event, file) {
                    ...
                    context.cordova.raw.prepare().then(function() {
                        ...
                        platform_wwws.forEach(function(platDir) {
                            var platformIndexLocal = path.join(platDir, startPage);
